...
<body>
    ...
    if(isset($_POST['submit']))
    {
        ...
        $insert_users_query=mysqli_query($dbcon, "insert into users (username,password) values ('$user_name','$user_pass')");
    ...
    ?>
        <div class="add-user" style="margin-top:200px;">
            <div class="container">
                <div class="row">
                        ...
                        <div class="panel panel-success" style="height:250px;">
                            ...
                            <fieldset>
                                <form method="post" action="">
                                    ...
                                    <br>
                                    <input class="btn-success" type="submit" name="submit">
                                </form>
                            </fieldset>
                        </div>
                    </div>
